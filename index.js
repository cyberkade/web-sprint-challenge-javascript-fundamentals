...
// nestedFunction can access the variable internal because of closure. nestedFunction reaches out of it's scope to find internal, because internal doesn't exist within nestedFunction's scope.
// This is all possible due to nestedFunction being nested inside of myFunction, which allows nestedFunction to have access to myFunction's code.
// Side Note: Due to external being global scoped, both functions have access to external.
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(data){
    let displayNames = data.map((item)=>{
  ...
  */
  ...
  function lowerCaseNames(data){
    let lowercaseNames = data.map((item)=>{
...
function greeting(first,last){
  ...
  console.log('greet:',consume("Mary", "Poppins", greeting)); // Hello Mary Poppins, nice to meet you!
